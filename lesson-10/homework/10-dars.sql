...
CREATE TABLE Enrollments ( EnrollmentID INT PRIMARY KEY IDENTITY, 
                           StudentID INT, 
						   CourseID INT, 
...
(1, 1), (2, 1), (7, 1), (11, 1), (20, 1), 
(25, 1), (33, 1), (3, 2), (9, 2), (14, 2),
(22, 2), (28, 2), (35, 2), (5, 3), (13, 3), 
(21, 3), (27, 3), (34, 3), (10, 4), (16, 4), 
(24, 4), (30, 4), (37, 4), (6, 5), (15, 5),
(23, 5), (29, 5), (36, 5);
...
select Employees.Name as EmployeeName,Employees.Salary,Departments.DepartmentName from Employees                    --Task 1
inner join Departments
on Employees.DepartmentID=Departments.DepartmentID
where Salary>50000


Select Customers.FirstName,Customers.LastName,  Year(OrderDate) from Customers                            --Task 2
inner join Orders
on Customers.CustomerID=Orders.CustomerID
where Year(OrderDate)=2023

select Employees.Name as EmployeeName,Departments.DepartmentName from Employees                    --Task 3
left outer join Departments
on Employees.DepartmentID=Departments.DepartmentID
where DepartmentName is Null


select Suppliers.SupplierName,Products.ProductName from Suppliers                   --Task 4
full outer  join  Products
on Products.SupplierID=Suppliers.SupplierID

Select Orders.OrderID,Orders.OrderDate,Payments.PaymentDate,Payments.Amount from Orders            --Task 5
full outer join Payments
on Orders.OrderID=Payments.OrderID


Select E.Name as EmployeeName,M.Name as ManagerName From Employees as E                            --Task 6
...
Select Students.Name as StudentName , Courses.CourseName from Enrollments             --Task 7
...
Select Customers.FirstName,Customers.LastName,Orders.Quantity from Customers             --Task 8
inner join Orders
on Customers.CustomerID=Orders.CustomerID
where Quantity>3

select Employees.Name as EmoployeeName ,Departments.DepartmentName from Employees                    --Task 9
inner join Departments
on Employees.DepartmentID=Departments.DepartmentID
...
select Employees.Name as EmoployeeName ,Departments.DepartmentName from Employees                    --Task 10
inner join Departments
on Employees.DepartmentID=Departments.DepartmentID
where DepartmentName = 'Human Resources'

Select Products.ProductID,Products.ProductName from Products                 --Task 11
left join  Sales
on Products.ProductID=Sales.ProductID
where Sales.ProductID is null

select Customers.FirstName,Customers.LastName,count(Orders.OrderID) AS TotalOrders from Customers            --Task 12
inner join Orders 
on Customers.CustomerID=Orders.CustomerID
...
select Employees.Name as EmoployeeName ,Departments.DepartmentName from Employees                    --Task 13
...
Select E.Name as Employee1,M.Name as Employee2,E.ManagerID from Employees as E                    --Task 14 savol
...
select Orders.OrderID,year(Orders.OrderDate),Customers.FirstName,Customers.LastName from Orders               --Task 15
...
select Employees.Name as EmployeeName,Employees.Salary,Departments.DepartmentName from Employees                    --Task 16
inner join Departments
on Employees.DepartmentID=Departments.DepartmentID

where Salary>60000 and DepartmentName = 'Sales'



Select Orders.OrderID,Orders.OrderDate,Payments.PaymentDate,Payments.Amount from Orders            --Task 17
inner join Payments
on Orders.OrderID=Payments.OrderID


Select Products.ProductID,Products.ProductName from Products                 --Task 18
left join  Orders
...
Select E.Name as EmployeeName,E.Salary from Employees as E                       --Task 19 
inner join Employees as M
...
Select Orders.OrderID,Orders.OrderDate from Orders                   --Task 20
left join Payments
on Orders.OrderID=Payments.OrderID
where Orders.OrderDate<'2020-01-01' and Payments.OrderID is null


Select Products.ProductID,Products.ProductName from Products                                         --Task 21 SAVOL
left JOIN Categories
on Products.ProductID=Categories.CategoryID
WHERE Categories.CategoryID is null


Select  E.Name as Employee1,M.Name as Employee2,E.ManagerID,E.Salary from Employees as E           --Task 22
inner join Employees as M
on E.ManagerID=M.ManagerID and E.EmployeeID<>M.EmployeeID
where  E.Salary>60000 


select Employees.Name as EmployeeName,Departments.DepartmentName from Employees                    --Task 23
inner join Departments
on Employees.DepartmentID=Departments.DepartmentID
...
Select Sales.SaleID,Products.ProductName,Sales.SaleAmount from Products                    --Task 24
inner join Sales
on Products.ProductID=Sales.ProductID
where Sales.SaleAmount>500


select Students.StudentID,Students.Name as StudentName from Enrollments                        --Task 25
inner join Courses
on Enrollments.CourseID=Courses.CourseID
inner join Students 
on Enrollments.StudentID=Students.StudentID
where Courses.CourseName not in ('Math 101')
...
Select Products.ProductID,Products.ProductName,Categories.CategoryName from Products                    --Task 27 SAVOL
