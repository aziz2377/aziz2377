...
select top 5 * from Employees                                                       --Step 1
...
select distinct ProductName from Products                                 --Step 2


select * from Products where Price > 100                                   --Step 3



select * from Customer                                                               --Step 4
where FirstName like '%A%'

select * from Products                                                      --Step 5
order by Price asc


select * from Employees where DepartmentName='HR' and Salary>= 60000         --Step 6


select ISNULL (Email,'noemail@example.com') as NoInformation from Employees   --Step 7


SELECT * 
FROM Products
WHERE Price BETWEEN 50 AND 100;                                                  --Step 8


SELECT DISTINCT Category, ProductName                                              --Step 9
FROM Products;

SELECT DISTINCT Category, ProductName                                                --Step 10
FROM Products
...
Select  top 10 * from Products        --Step 11
order by Price desc

select coalesce( FirstName,'non-NUUL' ) as NoInformation    --Step 12
From Employees

select coalesce( LastName,'non-NUUL' ) as NoInformation 
From Employees



Select distinct Category , Price                --Step 13
from Products

Select * from Employees
where DepartmentName = 'Marketing' and Age between 30 and 40     --Step 14



SELECT EmployeeID, Salary                                                         --Step 15 
...
select * from Products                                                               --Step 16
where Price<=1000 and StockQuantity >50
order by StockQuantity asc

select * from Products                                                               --Step 17
where ProductName like '%e%'



select * from Employees
where DepartmentName in ('HR','IT','Finance')                                         --Step 18
...
order by City asc, PostalCode desc;                                                                  --19
...
Select top (10) SaleAmount  From Sales                             --Step 20
order by SaleAmount desc

SELECT CONCAT(FirstName, ' ', LastName) AS FullName               --Step 21
FROM Employees;


SELECT DISTINCT Category,ProductName,Price from Products        --Step 22   
where Price>50
...
select * from Employees
where DepartmentName in ('HR','IT') and Age<30                  --Step 24



Select * from Customers
where Email like  '%@gmail.com%'                                 --Step 25


SELECT FirstName,LastName,DepartmentName                                                            --Step 26     
FROM Employees
WHERE Salary > ALL (
    SELECT Salary
    FROM Employees
...
SELECT *
FROM Orders
WHERE OrderDate BETWEEN DATEADD(DAY, -180, GETDATE()) AND GETDATE();       --Step 27
